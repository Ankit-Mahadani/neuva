...
# When invoked as an entry point, ensure the src directory is on the path
# so that the parser and interpreter sub-packages resolve correctly.
sys.path.insert(0, os.path.dirname(__file__))

from parser import NeuvaParser
from parser.parser import ParseError
from interpreter.interpreter import NeuvaInterpreter, RuntimeError_
